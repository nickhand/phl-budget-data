...
class BudgetedSpendingParams(BaseModel):
...
def load_budgeted_department_spending(
    ...
    data_folder = BudgetedDepartmentSpending.get_data_directory("processed") / kind / "budget"
...
load_budgeted_department_spending.model = BudgetedSpendingParams  # type: ignore

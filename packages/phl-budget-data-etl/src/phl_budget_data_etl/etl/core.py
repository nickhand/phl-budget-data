...
def validate_data_schema(data_schema: type[BaseModel]) -> Callable:
    """
    ...
    def Inner(func: Callable) -> Callable:
        def wrapper(*args, **kwargs):  # type: ignore
            ...
            if isinstance(res, pd.DataFrame):
                ...
                # Replace NaN with None so pydantic Optional fields validate correctly
                df_dict = res.where(res.notna(), other=None).to_dict(orient="records")

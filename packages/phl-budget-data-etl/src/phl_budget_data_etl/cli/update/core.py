...
def generate_commands(update: click.Group) -> None:
    ...
    def update_monthly_wage_collections() -> None:
        ...
        # Log
        logger.info(f"Checking for PDF report for update since month '{month}' and year '{year}'")
    ...
    def update_monthly_city_collections() -> None:
    ...
    def update_monthly_school_collections() -> None:
    ...
    *etls: type[ETLPipeline],
    ...
    for dt in new_months:
        ...
        with tempfile.TemporaryDirectory() as tmpdir, cwd(tmpdir):
            ...
            # Download the PDF
            with downloaded_pdf(driver, remote_pdf_path, tmpdir, interval=1) as pdf_path:
            ...
            try:
                for cls in etls:
                    ...
                    # Run the ETL
                    cls_any: Any = cls
                    report = cls_any(year=year, month=month)

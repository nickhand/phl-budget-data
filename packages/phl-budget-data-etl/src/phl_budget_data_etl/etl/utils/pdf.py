...
def words_to_table(
    ...
    columns = fuzzy_groupby(words, lower_tol=column_tolerance, upper_tol=column_tolerance, key="x1")
...
def find_phrases(words: list[Word], *keywords: str) -> list[Word] | None:
    """
...
def get_pdf_words(
    ...
    x_tolerance: int = 3,
    y_tolerance: int = 3,
    footer_cutoff: int | None = None,
    header_cutoff: int | None = None,
) -> list[Word]:
    """
